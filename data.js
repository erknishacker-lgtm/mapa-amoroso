...
window.MAPA_DATA = {
  ...
  offer: {
    ...
    bonuses: {
      ...
      title: "Ao desbloquear seu Mapa Completo",
      highlight: "Você recebe tudo isso sem custo adicional!",
      subtitle:
        "Conteúdos práticos de autoconhecimento para te ajudar a se reconectar consigo mesma, organizar a confusão e viver relações com mais clareza.",
      totalLabel: "Valor total dos bônus",
      totalValue: "R$ 111,00",
      ctaBanner: "Hoje você recebe tudo incluso!",
      ctaSub: "Sem custo adicional",
      note: "Valores de referência (valor percebido). Inclusos na compra do Mapa Completo — não são preços anteriores de venda avulsa.",
      trusts: [
        { icon: "shield", label: "Conteúdos 100% digitais" },
        { icon: "lock", label: "Acesso imediato" },
        { icon: "card", label: "Pagamento único e seguro" },
        { icon: "heart", label: "Garantia de 7 dias" },
      ],
      footer: "Tudo o que você precisa para se organizar emocionalmente — comece por você.",
      items: [
        {
          num: "1",
          name: "Ritual de Limpeza e Renovação Emocional",
          alt: "Banho de Renovação Amorosa",
          desc: "Ritual guiado de 15 minutos, banho aromático (ou alternativa), respiração e compromisso de recomeço.",
          value: "R$ 27",
          visual: "bath",
          bookTitle: "Ritual de\nLimpeza",
          bookSub: "Renovação emocional",
        },
        {
          num: "2",
          name: "Ritual de Desapego da Relação Confusa",
          alt: "Ritual de Corte da Confusão Emocional",
          desc: "Realidade × expectativa, carta de encerramento, gatilhos, plano de 7 dias e checklist de clareza.",
          value: "R$ 37",
          visual: "letter",
          bookTitle: "Desapego\nEmocional",
          bookSub: "Clareza na confusão",
        },
        {
          num: "3",
          name: "Kit de Proteção para Dias de Recaída",
          alt: "Escudo de Proteção Emocional",
          desc: "Pausa antes de agir, cartão de clareza, roteiros de limite e plano de emergência de 24 horas.",
          value: "R$ 47",
          visual: "shield",
          bookTitle: "Escudo de\nProteção",
          bookSub: "Dias de recaída",
        },
      ],
    },
  },
